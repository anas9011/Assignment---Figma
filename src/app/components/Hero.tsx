...
const HeroSection = () => {
  return (
    <section className="grid grid-cols-1 md:grid-cols-2">
      {/* Left Side */}
      <div className=" w-[1280px] h-[500px] top-[60px] left-[80px] bg-[#2A254B] text-white p-10 flex flex-col justify-center">
        <h2 className="w-[513px] h-[90px] text-4xl font-bold mb-6">The furniture brand for the future, with timeless designs</h2>
        <button className="w-[170px] h-[56px] bg-[#F9F9F926] hover:bg-gray-600 text-white  py-3 px-6 rounded">
          View Collection
        </button>
